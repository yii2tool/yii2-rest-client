 ...
 * @var \yii2tool\restclient\web\models\ResponseRecord $record
 */
?>
        ...
        <div class="tab-content">
            ...
            <div id="response-body" class="tab-pane">
                ...
                if($frame) {
	                ...
	                $formatterConfig = 'yii2tool\restclient\web\formatters\RawFormatter';
	                ...
	                /** @var \yii2tool\restclient\web\formatters\RawFormatter $formatter */
	                $formatter = \Yii::createObject($formatterConfig);
	                echo $formatter->format($record);
	                \yii2tool\restclient\web\HighlightAsset::register($this);
